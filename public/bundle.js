...
var setStripe = /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0, _stripeJs.loadStripe)('pk_test_qpk8XXIK4nkQNnyLqJ3RH5Mt009GgCH5Lr');

          case 2:
            return _context.abrupt("return", strip = _context.sent);
  ...
  return function setStripe() {
    return _ref.apply(this, arguments);
  };
}();

var stripe = setStripe();
